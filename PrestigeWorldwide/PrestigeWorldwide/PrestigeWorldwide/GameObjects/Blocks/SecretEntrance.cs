...
{
    public class SecretEntrance:IBlockObstacle
    {
        Vector2 location;
        Texture2D greenPipe;
        Level level;
        ...
        public SecretEntrance(Texture2D greenPipe, Vector2 location, Level level)
        {
        ...
        public void Update()
        {
            ...
            if (decrement == 100)
            {
                ...
                level.mario.location.X = 35;
                level.mario.location.Y = 800;
                level.camera.screenRegion = 2;
                triggered = false;
                decrement = 0;
        ...
        {
            System.Console.WriteLine("Entering Secret Level");
            if (triggered == false)
            {
