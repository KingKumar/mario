...
{
    class FireMarioJumpingSprite : IAnimatedSprite
    {
        ...
        // Constructor
        public FireMarioJumpingSprite(int isMovingRight, Level level, int nextFrame, Vector2 location)
        {
            this.isMovingRight = isMovingRight;
            this.level = level;
            this.texture = level.ContentLoad("Mario/Fire/FireJumpingMario");
