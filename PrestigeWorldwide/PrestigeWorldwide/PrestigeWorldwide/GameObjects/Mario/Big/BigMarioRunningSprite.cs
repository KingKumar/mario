...
{
    class BigMarioRunningSprite : IAnimatedSprite
    {
        // Fields
        int currentFrame;
        int totalFrames;
        ...
        // Constructor
        public BigMarioRunningSprite(int isMovingRight, Level level, int nextFrame, Vector2 location)
        {
            this.isMovingRight = isMovingRight;
            this.level = level;
            this.texture = level.ContentLoad("Mario/Big/BigRunningMario");
        ...
        public void Draw()
        {
            ...
            level.spriteBatch.Draw(texture, destinationRectangle, sourceRectangle, color);
