...
{
    class IceMarioIdleSprite : IAnimatedSprite
    {
        ...
        public IceMarioIdleSprite(int isMovingRight, Level level, Vector2 location)
        {
            this.isMovingRight = isMovingRight;
            this.level = level;
            this.texture = level.ContentLoad("Mario/Ice/IceIdleMario");
