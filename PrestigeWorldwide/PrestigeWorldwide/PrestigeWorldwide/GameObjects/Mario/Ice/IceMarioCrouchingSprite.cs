...
{
    class IceMarioCrouchingSprite : IAnimatedSprite
    {
       int isMovingRight;
        Level level;
        Texture2D texture;
        ...
        public IceMarioCrouchingSprite(int isMovingRight, Level level, Vector2 location)
        {
            this.isMovingRight = isMovingRight;
            this.level = level;
            this.texture = level.ContentLoad("Mario/Ice/IceCrouchingMario");
