...
{
    class IceBallExplosion:IIceBallState
    {
        int totalFrame;
        int currentFrame;
        int frameDelay;
        ...
        public IceBallExplosion(Level level)
        {
            this.level = level;
            this.texture = level.ContentLoad("Mario/Ice/IceballExplosion");
            totalFrame = MarioConstants.iceBallExplosionFrameCount;
            currentFrame = 0;
            frameDelay = 0;
        }
