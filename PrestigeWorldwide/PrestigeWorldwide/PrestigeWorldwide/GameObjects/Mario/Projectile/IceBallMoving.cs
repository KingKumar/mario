...
{
    class IceBallMoving:IIceBallState
    {
        Texture2D texture;
        Level level;
        int currentFrame = 0;
        int totalFrames = MarioConstants.iceBallMovingFrameCount;
        int frameDelay;
        int isMovingRight;
        ...
        public IceBallMoving(Level level)
        {
            this.level = level;
            this.texture = level.ContentLoad("Mario/Ice/Iceball");
