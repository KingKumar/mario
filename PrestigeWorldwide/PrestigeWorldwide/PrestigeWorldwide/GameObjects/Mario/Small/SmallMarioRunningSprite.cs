...
{
    class SmallMarioRunningSprite : IAnimatedSprite
    {
        // Fields
        int currentFrame;
        int totalFrames;
        ...
        // Constructor
        public SmallMarioRunningSprite(int isMovingRight, Level level, int nextFrame, Vector2 location)
        {
            this.isMovingRight = isMovingRight;
            this.level = level;
            this.texture = level.ContentLoad("Mario/Small/SmallRunningMario");
